...
export const BodyScan=()=>{
 ...
 setData({...data,d});
    ...
    <li className="l_i">
      ...
      <input className=" User" type="text"  onChange={handleChange} required/>
     <label className="unit">cm</label>
       </div>
    </li>
    <li className="l_i">
       <p className="heading">How much do you weigh?</p>
       <p className="text">It's OK to estimate. You can update this later.</p>
       <div className="Userdetail">
      ...
      <label className="unit">kg</label>
        ...
        <li className="l_i">
            ...
            <p className="text">Don't worry. This doesn't affect your daily calorie goal and you can always change it later.</p>
        <div className="Userdetail">
