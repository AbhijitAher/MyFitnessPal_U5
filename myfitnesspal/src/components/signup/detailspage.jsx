...
export const Detail=()=>{
 ...
 setData({...data,d});
    ...
    <p className="head_para">Please select which sex we should use to calculate your calorie needs.</p>
    ...
    <li className="list_li">
        ...
        <div className="dates">
        <input  type="date"placeholder="dd/mm/yy"  onChange={handleChange}/>
        </div>
    </li>
    <li className="list_li">
       ...
       <Select className="textbox"options={options} value={value} placeholder="country" size='lg' onChange={changeHandler} />

       </div>
       <div className="detail">
      
       <input className=" pin1" type="number" placeholder=" "  onChange={handleChange} required/>
       <label className=" pin">Zipcode</label>
        </div>
        </div>
    </li>
   <li>
   <p className="para_text">We use this information to calculate an accurate calorie goal for you.</p>
