...
export const WeightReduce=()=>{
 const [text,setText]=React.useState("");
    return(
        ...
        <p className="para">Let's break down your overall health goal into a weekly one you can maintain. Slow-and-steady is best!</p>
        <ul className="order">
        <li className="list">
    ...
    <li className="list">
        ...
        <label for='radio2'>Lose 0.25 kilograms per week (Recommeneded)</label>
        </div>
    </li>
    <li className="list">
        <div className="weightsel_type">
